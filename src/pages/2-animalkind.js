...
const SecondPage = () => (
  <Layout>
    ...
    <div className={style.copy}>
      ...
      <h2>Aubre</h2>
      <p>
        Aubre watched the crown prince’s guards load the beast into the back of
        the <i>hurcha</i>, a small wood cart with a short bed, hitched to a team
        of three woolly yaks.
      </p>

      <p>
        Although she'd accompanied her father into the Black Forest many times
        before, she’d never seen any creature quite like it. The animal was only
        a little bigger than she was, but it looked more like a person in a
        heavy coat than anything she’d ever seen in the woods. Its legs, arms
        and even torso looked like her own, and except for a long tail and
    ...
    <div className={style.copy}>
      <p>
        A man dressed in heavy leathers put one hand on the princes shoulder,
        prizing him away from the animals face with non-negotiable firmness.
      </p>
      <p>
        “Anyone ever tell you not to stand behind a horse, son?” he said, but he
        was easily brushed off as the prince went on with his retelling of what
